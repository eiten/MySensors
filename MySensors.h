...
#include "hal/crypto/generic/MyCryptoGeneric.cpp"
#elif defined(CubeCell_Module) || defined(CubeCell_Module_Plus) ||defined(CubeCell_Board) || defined(CubeCell_Capsule) || defined(CubeCell_BoardPlus) || defined(CubeCell_GPS) || defined(CubeCell_HalfAA)
